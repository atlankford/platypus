!function (a) {
    ...
    !function () {
        ...
        b = function (b, c, d) {
            ...
            if (d[b])return d[b];
            if (d[b] = {}, !a[b])throw new Error("Could not find module " + b);
            for (var f, g = a[b], h = g.deps, i = g.callback, j = [], k = 0, l = h.length; l > k; k++)j.push("exports" === h[k] ? f = {} : c(e(h[k])));
        ...
        c["default"] = function (a, b) {
            return new f(function (b) {
                ...
                for (var m = new Array(l), n = 0; n < a.length; n++)k = a[n], h(k) ? j(n, d(k)) : f.resolve(k).then(c(n), i(n))
            }, b)
        }
        ...
        c["default"] = function (a, b, c) {
            return d.all(a, c).then(function (a) {
                ...
                return d.all(g, c).then(function (b) {
                    for (var c = new Array(f), d = 0, e = 0; f > e; e++)b[e] === !0 && (c[d] = a[e], d++);
                    return c.length = d, c
                })
            })
        }
        ...
        c["default"] = function (a) {
            return new f(function (b) {
                ...
                if (0 === o)return void b(m);
                for (var p = 0; p < n.length; p++)l = n[p], k = a[l], g(k) ? j(l, d(k)) : f.resolve(k).then(c(l), i(l))
            })
        }
        ...
        c["default"] = function (a) {
            return new d(function (b, c) {
                ...
                for (var n = 0; n < l.length; n++)j = l[n], i = a[j], e(i) ? (k[j] = i, 0 === --m && b(k)) : d.resolve(i).then(g(j), h)
            })
        }
        ...
        c["default"] = function (a, b) {
            function c() {
                for (var c = arguments.length, e = new Array(c), h = 0; c > h; h++)e[h] = arguments[h];
                var i;
                return f || g || !b ? i = this : (console.warn('Deprecation: RSVP.denodeify() doesn\'t allow setting the "this" binding anymore. Use yourFunction.bind(yourThis) instead.'), i = b), d.all(e).then(function (c) {
                    function e(d, e) {
                        function h() {
                            for (var a = arguments.length, c = new Array(a), h = 0; a > h; h++)c[h] = arguments[h];
                            var i = c[0], j = c[1];
                            if (i)e(i); else if (f)d(c.slice(1)); else if (g) {
                                var k, l, m = {}, n = c.slice(1);
                                for (l = 0; l < b.length; l++)k = b[l], m[k] = n[l];
                                d(m)
                            } else d(j)
                        }
        ...
        b["default"] = function (a, b) {
            ...
            return new e(function (b, f) {
                ...
                for (var l = 0; l < a.length; l++)i = a[l], d(i) ? (k[l] = i, 0 === --j && b(k)) : e.resolve(i).then(g(l), h)
            }, b)
        }
        ...
        if (E.async = K, "undefined" != typeof window && "object" == typeof window.__PROMISE_INSTRUMENTATION__) {
            ...
            F("instrument", !0);
            for (var M in L)L.hasOwnProperty(M) && s(M, L[M])
        }
